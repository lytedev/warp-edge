...
function game:draw()
    ...
    debugText = debugText .. string.format("Camera Position: %i, %i\n", math.floor(camera.x), math.floor(camera.y))
    debugText = debugText .. string.format("Player Size: %d, %d\n", self.player.size.x, self.player.size.y)
    ...
    debugText = debugText .. string.format("Player Facing: %i, %i\n", self.player.facing.x, self.player.facing.y)
    debugText = debugText .. love.timer.getFPS() .. "\n"
